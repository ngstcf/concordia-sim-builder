...
export const TEMPLATES: TemplateMetadata[] = [
  { id: 'coffee', name: 'Coffee Shop Demo', description: 'Quick 5-step demo with two agents chatting', category: 'Basic', tags: ['sequential'], agentCount: 2, stepCount: 5, engineType: 'sequential', gmPrefab: 'generic__GameMaster', agentNames: ['Alice', 'Bob'], keywords: 'coffee shop casual conversation' },
  { id: 'peace', name: 'Peace Negotiation', description: 'Russia-Ukraine diplomatic talks with mediator', category: 'Basic', tags: ['sequential', 'components', 'player-context'], agentCount: 2, stepCount: 20, engineType: 'sequential', gmPrefab: 'generic__GameMaster', agentNames: ['Agent R', 'Agent U'], keywords: 'diplomacy ceasefire war conflict UN mediator' },
  { id: 'planning', name: 'Planning Agent', description: 'Strategic product launch with planning prefab', category: 'Prefab Types', tags: ['sequential', 'components', 'player-context'], agentCount: 3, stepCount: 15, engineType: 'sequential', gmPrefab: 'generic__GameMaster', agentNames: ['Sarah Chen', 'Marcus Rodriguez', 'Emily Watson'], keywords: 'product launch strategy planning' },
  { id: 'scripted-entity', name: 'Scripted Entity', description: 'Focus group moderator with exact scripted responses', category: 'Prefab Types', tags: ['sequential', 'components', 'scripted'], agentCount: 5, stepCount: 10, engineType: 'sequential', gmPrefab: 'generic__GameMaster', agentNames: ['Dr. Chen', 'Jordan', 'Sam', 'Maria', 'Alex'], keywords: 'focus group research scripted moderator' },
  { id: 'context-aware-moderator', name: 'Context-Aware Moderator', description: 'Support group with context-adaptive scripted responses', category: 'Prefab Types', tags: ['sequential', 'components', 'scripted', 'player-context'], agentCount: 4, stepCount: 12, engineType: 'sequential', gmPrefab: 'generic__GameMaster', agentNames: ['Sarah', 'Marcus', 'Elena', 'David'], keywords: 'support group therapy adaptive moderator' },
  ...
  { id: 'nested-simulation', name: 'Nested Simulation Demo', description: 'Agents run mini-simulations to plan ahead', category: 'Advanced', tags: ['sequential', 'nested-sim'], agentCount: 2, stepCount: 15, engineType: 'sequential', gmPrefab: 'generic__GameMaster', agentNames: ['Alice', 'Bob'], keywords: 'nested simulation planning' },
  { id: 'grounded-variables', name: 'Grounded Variables Demo', description: 'Track quantitative metrics during simulation', category: 'Advanced', tags: ['sequential', 'grounded-vars', 'player-context'], agentCount: 3, stepCount: 20, engineType: 'sequential', gmPrefab: 'generic__GameMaster', agentNames: ['Project Manager', 'Senior Developer', 'Junior Developer'], keywords: 'metrics tracking variables software project' },
