...
Five completed simulation runs are included in the [`logs/`](logs/) directory, spanning peace negotiation, game theory, disaster response, and SDG-aligned scenarios. Each run was configured and executed entirely through the web interface.

Each simulation produces one output file:
