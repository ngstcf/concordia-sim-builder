...
The `logs/` directory contains 5 completed simulation runs. Each simulation produces one file:

- **`.html`** — Concordia simulation log (interactive HTML with tabbed agent views generated by `PythonObjectToHTMLConverter`)

| # | Scenario | Agents | Template |
|---|----------|--------|----------|
| 1 | **State Formation** — Settlers in a resource-rich frontier (SDG 16) | 4 (Marcus Chen, Sofia Rodriguez, James Morrison, Viktor Petrov) | State Formation |
| 2 | **Labor Strike** — Manufacturing company announces 15% wage cut (SDG 8) | 4 (Elena Vasquez, David Kim, Amina Johnson, Richard Sterling) | Labor Action |
| 3 | **Peace Negotiation** — Russia-Ukraine talks at Istanbul, Jan 2026 | 2 (Agent R, Agent U) | Peace Negotiation |
| 4 | **Strategic Game** — Iterated Prisoner's Dilemma | 2 (Alex, Sam) | Strategic Game |
| 5 | **Flood Evacuation** — Coastal town urgent flood warning (SDG 11/13) | 5 (Sarah Williams, Robert Thompson, Javier Rodriguez, Eleanor O'Brien, Pastor Moses) | Disaster Response |
