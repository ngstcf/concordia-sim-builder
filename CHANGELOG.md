...
- Stochastic sampling controls for experiment setup — support probabilistic population/activity configuration (for example persona trait distributions and role/activity-rate variation) to improve inter-run realism and robustness testing
